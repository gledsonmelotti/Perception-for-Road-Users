...
train_PedestrianNon_dir_RGB='.../RGB/train/PedestrianNon'

test_Pedestre_dir_RGB='.../RGB/test/Pedestrian'
test_PedestrianNon_dir_RGB='.../RGB/test/PedestrianNon'

validation_Pedestre_dir_RGB='.../RGB/validation/Pedestrian'
validation_PedestrianNon_dir_RGB='.../RGB/validation/PedestrianNon'
...
print('total training Non Pedestrian images-RGB:', len(os.listdir(train_PedestrianNon_dir_RGB)))

print('total-test Pedestrian images-RGB:', len(os.listdir(test_Pedestre_dir_RGB)))
print('total test Non Pedestrian images-RGB:', len(os.listdir(test_PedestrianNon_dir_RGB)))

print('total-validation Pedestrian images-RGB:', len(os.listdir(validation_Pedestre_dir_RGB)))
print('total-validation Non Pedestrian images-RGB:', len(os.listdir(validation_PedestrianNon_dir_RGB)))

print('total-train images-RGB:', len(os.listdir(train_Pedestre_dir_RGB)) + len(os.listdir(train_PedestrianNon_dir_RGB)))
print('total-validation images-RGB:', len(os.listdir(validation_Pedestre_dir_RGB)) + len(os.listdir(validation_PedestrianNon_dir_RGB)))
print('total-test images-RGB:', len(os.listdir(test_Pedestre_dir_RGB)) + len(os.listdir(test_PedestrianNon_dir_RGB)))

print('################################')
print('total of images-RGB:', len(os.listdir(train_Pedestre_dir_RGB)) + len(os.listdir(train_PedestrianNon_dir_RGB)) + len(os.listdir(validation_Pedestre_dir_RGB)) + len(os.listdir(validation_PedestrianNon_dir_RGB)) + len(os.listdir(test_Pedestre_dir_RGB)) + len(os.listdir(test_PedestrianNon_dir_RGB)))
print('################################')
...
train_PedestrianNon_dir_DM='.../MP/train/PedestrianNon'

test_Pedestre_dir_DM='.../MP/test/Pedestrian'
test_PedestrianNon_dir_DM='.../MP/test/PedestrianNon'

validation_Pedestre_dir_DM='.../MP/validation/Pedestrian'
validation_PedestrianNon_dir_DM='.../MP/validation/PedestrianNon'
...
print('total-train images-DM:', len(os.listdir(train_Pedestre_dir_DM)) + len(os.listdir(train_PedestrianNon_dir_DM)))
print('total-validation images-DM:', len(os.listdir(validation_Pedestre_dir_DM)) + len(os.listdir(validation_PedestrianNon_dir_DM)))
print('total-test images-DM:', len(os.listdir(test_Pedestre_dir_DM)) + len(os.listdir(test_PedestrianNon_dir_DM)))

print('################################')
print('total of images-DM:', len(os.listdir(train_Pedestre_dir_DM)) + len(os.listdir(train_PedestrianNon_dir_DM)) + len(os.listdir(validation_Pedestre_dir_DM)) + len(os.listdir(validation_PedestrianNon_dir_DM)) + len(os.listdir(test_Pedestre_dir_DM)) + len(os.listdir(test_PedestrianNon_dir_DM)))
print('################################')


################### Número Total de Amostras de Treino e Validação
nb_train_samples = len(os.listdir(train_Pedestre_dir_DM)) + len(os.listdir(train_PedestrianNon_dir_DM)) 
nb_validation_samples = len(os.listdir(validation_Pedestre_dir_DM)) + len(os.listdir(validation_PedestrianNon_dir_DM))
nb_test_samples = len(os.listdir(test_Pedestre_dir_DM)) + len(os.listdir(test_PedestrianNon_dir_DM)) 
...
for n, id_ in tqdm(enumerate(trainPN_ids), total=len(trainPN_ids)):
        path1 = train_PedestrianNon_dir_RGB + '/'+ id_
        path2 = train_PedestrianNon_dir_DM + '/'+ id_
        imgRGB = imageio.imread(path1)#[:,:,:img_channels]
        imgBFP = imageio.imread(path2)#[:,:,:img_channels]
        img = np.dstack((imgRGB,imgBFP))
        img = resize(img, (img_height, img_width), mode='constant', preserve_range=True)
...
for n, id_ in tqdm(enumerate(valPN_ids), total=len(valPN_ids)):
        path1 = validation_PedestrianNon_dir_RGB + '/'+ id_
        path2 = validation_PedestrianNon_dir_DM + '/'+ id_
        imgRGB = imageio.imread(path1)#[:,:,:img_channels]
        imgBFP = imageio.imread(path2)#[:,:,:img_channels]
        img = np.dstack((imgRGB,imgBFP))
        img = resize(img, (img_height, img_width), mode='constant', preserve_range=True)
...
print('total test PedestrianNon images:', len(os.listdir(test_PedestrianNon_dir_DM)))
...
basedirPN_RGB = test_PedestrianNon_dir_RGB
basedirPN_BFP = test_PedestrianNon_dir_DM
testPN=testPN_ids

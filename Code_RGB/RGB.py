...
train_Pedestrian_dir_RGB='.../train/Pedestrian'
train_PedestrianNon_dir_RGB='.../train/PedestrianNon'

test_Pedestrian_dir_RGB='.../test/Pedestrian'
test_PedestrianNon_dir_RGB='.../test/PedestrianNon'

validation_Pedestrian_dir_RGB='.../validation/Pedestrian'
validation_PedestrianNon_dir_RGB='.../validation/PedestrianNon'

train_dir_RGB='.../train'
test_dir_RGB='.../test'
validation_dir_RGB='.../validation'

print('total training Pedestrian images-RGB:', len(os.listdir(train_Pedestrian_dir_RGB)))
print('total training Non Pedestrian images-RGB:', len(os.listdir(train_PedestrianNon_dir_RGB)))

print('total test Pedestrian images-RGB:', len(os.listdir(test_Pedestrian_dir_RGB)))
print('total test Non Pedestrian images-RGB:', len(os.listdir(test_PedestrianNon_dir_RGB)))

print('total validation Pedestrian images-RGB:', len(os.listdir(validation_Pedestrian_dir_RGB)))
print('total validation Non Pedestrian images-RGB:', len(os.listdir(validation_PedestrianNon_dir_RGB)))

print('total train images-RGB:', len(os.listdir(train_Pedestrian_dir_RGB)) + len(os.listdir(train_PedestrianNon_dir_RGB)))
print('total validation images-RGB:', len(os.listdir(validation_Pedestrian_dir_RGB)) + len(os.listdir(validation_PedestrianNon_dir_RGB)))
print('total test images-RGB:', len(os.listdir(test_Pedestrian_dir_RGB)) + len(os.listdir(test_PedestrianNon_dir_RGB)))

print('################################')
print('total of images-RGB:', len(os.listdir(train_Pedestrian_dir_RGB)) + len(os.listdir(train_PedestrianNon_dir_RGB)) + len(os.listdir(validation_Pedestrian_dir_RGB)) + len(os.listdir(validation_PedestrianNon_dir_RGB)) + len(os.listdir(test_Pedestrian_dir_RGB)) + len(os.listdir(test_PedestrianNon_dir_RGB)))
print('################################')
     

nb_train_samples = len(os.listdir(train_Pedestrian_dir_RGB)) + len(os.listdir(train_PedestrianNon_dir_RGB)) 
nb_validation_samples = len(os.listdir(validation_Pedestrian_dir_RGB)) + len(os.listdir(validation_PedestrianNon_dir_RGB))
...
trainP_ids = next(os.walk(train_Pedestrian_dir_RGB))[2]
...
for n, id_ in tqdm(enumerate(trainP_ids), total=len(trainP_ids)):
        path1 = train_Pedestrian_dir_RGB + '/'+ id_
...
trainPN_ids = next(os.walk(train_PedestrianNon_dir_RGB))[2]
...
valP_ids = next(os.walk(validation_Pedestrian_dir_RGB))[2]
...
for n, id_ in tqdm(enumerate(valP_ids), total=len(valP_ids)):
        path1 = validation_Pedestrian_dir_RGB + '/'+ id_
        img = imageio.imread(path1)#[:,:,:img_channels]
        img = resize(img, (img_height, img_width), mode='constant', preserve_range=True)
        #img = np.expand_dims(img, axis=-1)
        X_valP[n] = img
...
valPN_ids = next(os.walk(validation_PedestrianNon_dir_RGB))[2]
...
print('total test Pedestrian images:', len(os.listdir(test_Pedestrian_dir_RGB)))
print('total test Non pedestrian images:', len(os.listdir(test_PedestrianNon_dir_RGB)))
...
basedirP = test_Pedestrian_dir_RGB
testP=testP_ids
predictP(basedirP, test_model, testP)

print('Predict and Probability to Non Pedestrian')
testPN_ids = next(os.walk(test_PedestrianNon_dir_RGB))[2]
...
basedirPN = test_PedestrianNon_dir_RGB
testPN=testPN_ids

...
Crop the 3D Point clouds regarding the projection on the 2D image-plane (Frame 114-KITTI Vision Benchmark Suite):

![Crop Point Cloud Frame 114](https://github.com/gledsonmelotti/Self-Driving-Vehicles/tree/master/Images/frame_114_juntos.png)
